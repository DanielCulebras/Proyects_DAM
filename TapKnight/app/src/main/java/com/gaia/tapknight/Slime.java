...
public class Slime extends Mobs{
    public Slime(int vida, int daño, float velocidadX, float velocidadY, int valor, Context c, ConstraintLayout myLayout) {
    ...
    public void setSprite(Context c, ConstraintLayout myLayout){
        ...
        if(super.sprite != null) {
            ...
            super.sprite.setImageResource(R.drawable.slime);
